...
try:
    ...
    while True:
        ...
        if key == '1':
            ...
            t2 = threading.Thread(target=move_motor, args=(step_2, direction_2, 133, delay_time/2, "Motor 2"))
            t3 = threading.Thread(target=move_motor, args=(step_3, direction_3, 222, delay_time, "Motor 3"))
            t2.start()
            t3.start()
            t2.join()
            t3.join()
            ...
            t1 = threading.Thread(target=move_motor, args=(step_1, direction_1, 222, delay_time/2, "Motor 1"))
