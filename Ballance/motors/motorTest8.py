...
try:
    ...
    while True:
        ...
        if key == '1':
            ...
            t1 = threading.Thread(target=move_motor, args=(step_2, direction_2, 10, delay_time, "Motor 2"))
            t1.start()
            t1.join()
        elif key == '3':
            ...
            t3 = threading.Thread(target=move_motor, args=(step_3, direction_3, 222, delay_time*.6, "Motor 3"))
            t2.start()
            t3.start()
            t2.join()
            t3.join()
            ...
            t1 = threading.Thread(target=move_motor, args=(step_1, direction_1, 222, delay_time*.6, "Motor 1"))
            t2 = threading.Thread(target=move_motor, args=(step_2, direction_2, 133, delay_time, "Motor 2"))
            t1.start()
            t2.start()
            t1.join()
