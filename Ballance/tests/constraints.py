...
if __name__ == "__main__":
    try:
        ...
        move_motor(step, 20, direction, True)  # Motor 1 clockwise
        time.sleep(1)
        move_motor(step2, 20, direction2, True)  # Motor 2 clockwise
        time.sleep(1)
        move_motor(step3, 20, direction3, True)  # Motor 3 clockwise
